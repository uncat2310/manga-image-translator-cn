...
async def dispatch(
    ...
    pil_cn_render.set_font(font_path)
...
def render(
    ...
    if render_horizontally:
        # Use PIL rendering for CJK text
        target_lang = getattr(region, 'target_lang', '')
        if is_cjk_lang(target_lang):
            temp_box = put_text_horizontal_cn(
                region.font_size,
